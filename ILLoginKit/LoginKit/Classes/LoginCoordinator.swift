...
open class LoginCoordinator: ConfigurationSource {
    ...
    public var namePlaceholder = "Username"
    ...
    open func login(viewController:UIViewController, email: String, password: String) {
        print("Implement this method in your subclass to handle login.")
    }

    open func signup(viewController:UIViewController,name: String, email: String, password: String) {
...
extension LoginCoordinator: LoginViewControllerDelegate {
    ...
    func didSelectLogin(_ viewController: UIViewController, email: String, password: String) {
        login(viewController: viewController,email: email, password: password)
    }
...
extension LoginCoordinator: SignupViewControllerDelegate {
    ...
    func didSelectSignup(_ viewController: UIViewController, email: String, name: String, password: String) {
        signup(viewController:viewController,name: name, email: email, password: password)
    }
